        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-7">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="filter__found">
                                    <h6><span>${danhSachSanPhamTimKiem.size() }</span> sản phẩm</h6>
                                </div>
                            </div>
                    ...
                    <div class="row">
                    	<c:forEach var="item" items="${danhSachSanPhamTimKiem }">
                    		<div class="col-lg-4 col-md-6 col-sm-6">
	                            <div class="product__item">
	                                <div class="product__item__pic set-bg" data-setbg="<c:url value='/assets/user/img/sanpham/${item.hinhAnh}'/>">
